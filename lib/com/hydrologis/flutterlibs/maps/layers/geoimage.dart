...
class GeoImageSource extends RasterLayerSource {
  ...
  GeoImageSource.fromMap(Map<String, dynamic> map) {
    ...
    _name = HU.FileUtilities.nameFromFile(relativePath, false);
  ...
  static List<dynamic> getImage(var map) {
    ...
    var ext = HU.FileUtilities.getExtension(path);
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
        ...
        child: Scaffold(
          appBar: AppBar(
            title: Text(
                SLL.of(context).geoImage_tiffProperties), //"Tiff Properties"
          ),
          body: ListView(
            children: <Widget>[
              Padding(
                    ...
                    children: <Widget>[
                      ListTile(
                        ...
                        title: Padding(
                          ...
                          child: Text(
                              SLL.of(context).geoImage_opacity), //"Opacity"
                        ),
                        subtitle: Row(
