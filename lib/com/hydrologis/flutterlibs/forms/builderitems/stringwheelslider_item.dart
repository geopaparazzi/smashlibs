...
class StringWheelSliderWidget extends AFormWidget {
  ...
  Future<void> configureFormItem(
    ...
    widgets.add(StringFieldConfigWidget(
        ...
        emptyIsNull: true));
    widgets.add(WheelSliderValuesConfigWidget(formItem, emptyIsNull: true));
    widgets.add(Divider(thickness: 3));
...
class WheelSliderValuesConfigWidget extends StatefulWidget {
  final SmashFormItem formItem;
  final bool emptyIsNull;
  WheelSliderValuesConfigWidget(this.formItem,
      {this.emptyIsNull = true, Key? key})
      : super(key: key);

  @override
  _WheelSliderValuesConfigWidgetState createState() =>
      _WheelSliderValuesConfigWidgetState();
}

class _WheelSliderValuesConfigWidgetState
    extends State<WheelSliderValuesConfigWidget> {
  var _url;
  @override
